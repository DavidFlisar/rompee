<div class="w-screen items-stretch">
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3 " href="https://nxbrew.com/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://orbispatches.com/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3 " href="https://gamezmedia.net/category/games-ps4/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3 " href="https://nopaystation.com/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal  h-32 m-3 " href="https://romslab.com/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3 " href="https://romspure.cc/roms/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3 " href="https://romsfun.com/roms" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal  h-32 m-3 " href="https://vimm.net/vault" target="_blank">
            <div>
