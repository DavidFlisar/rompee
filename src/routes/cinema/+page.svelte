<div class="w-screen items-stretch">
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://www.anime-base.net/calendar" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://uflix.cc/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://aniwave.to/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://sloflix.com/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal  h-32 m-3" href="https://risanke.net/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://ziv-zav.rtvslo.si/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://365.rtvslo.si/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://fmoviesz.to/" target="_blank">
            <div>
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3 indicator" href="https://cine.to/" target="_blank">
    ...
    <div class="inline-block">
        <a class="btn btn-accent card card-normal h-32 m-3" href="https://ihavenotv.com/" target="_blank">
            <div>
